execute if score @s credits matches 100.. run give @s firework_rocket{jumpUpgrade:1,CanPlaceOn:["minecraft:barrier"],display:{Name:'{"text":"Jump Boost Upgrade","color":"light_purple","italic":true}'},Enchantments:[{}]}
